...
class TimeFormat {
  ...
  static String getLastMessageTime(
    ...
    if (now.day == sent.day &&
        ...
        now.year == sent.year) {
      return TimeOfDay.fromDateTime(sent).format(context); // today → show time
    }
    return showYear
        ? '${sent.day} ${_getMonth(sent)} ${sent.year}' // show with year
        : '${sent.day} ${_getMonth(sent)}';             // show without year
  }
